...
Created by mohsen javid on Tue, 20 Jan 2009 (MIT)
http://code.activestate.com/recipes/576623-simple-pygtk-calculator/
"""
...
class CalculatorDemo(gtk.Window):
    def __init__(self, parent=None):
        ...
        self.add_accel_group(self.accelg)
