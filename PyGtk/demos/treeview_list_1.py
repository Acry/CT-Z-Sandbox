...
Referring to TreeModel Rows:
*Tree Paths
*TreeIters
*TreeRowReferences

The ListStore provides tabular data storage organized in rows and columns similar to a table in a relational database.
The ListStore is really a simplified version of a TreeStore where the rows have no children.
It has been created to provide a simpler (and presumably more efficient) interface to this common data model.
...
class ListStore1Demo(gtk.Window):
